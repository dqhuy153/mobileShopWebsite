<%@ Page Title="" Language="C#" MasterPageFile="~/KH/MasterPageKH.Master" AutoEventWireup="true" CodeBehind="DonHang.aspx.cs" Inherits="shopMobileOnline.KH.DonHang" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div id="dhNotLogin" runat="server" class="dh-notLogin">
            ...
            <asp:HyperLink ID="HyperLink2" runat="server" NavigateUrl="~/KH/KHDangNhap.aspx">Đăng nhập</asp:HyperLink>
        </div>
         ...
         <div id="qldh" runat="server" class="qldh-container">
            <div class="qldh-header">
                ...
                <div class="qldh-btnThemMoi-container">
                    <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/KH/KHTrangChu.aspx">
