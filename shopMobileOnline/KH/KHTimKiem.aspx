<%@ Page Title="" Language="C#" MasterPageFile="~/KH/MasterPageKH.Master" AutoEventWireup="true" CodeBehind="KHTimKiem.aspx.cs" Inherits="shopMobileOnline.KH.KHTimKiem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="listsp-container">
     <h4><b><asp:Label ID="lbSearch" runat="server" Text="" CssClass="tenNSX"></asp:Label></b></h4>
